...
export default function InfoScreen({showInfo, handleShowInfo, darkMode, handleToggleDarkMode}) {
  return (
    <>
      {showInfo ? (
        <>
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  <p className="my-4 text-gray-600 text-lg leading-relaxed">
                    Let's find top beers from nearby venues 
                  </p>
                  <p className="my-4 text-gray-600 text-lg leading-relaxed">
                ...
                <div className="flex items-center justify-between p-6 border-t border-solid border-gray-300 rounded-b">
                  ...
                  <label className="flex items-center">
                    <input type="checkbox" className="form-checkbox" onChange={() => handleToggleDarkMode()} checked={darkMode}/>
